...
public class VariableNamesTheme {
    public static void main(String[] args) {
        ...
        // символ &
        char andSymbol = '&';
        System.out.println("Символ & = " + andSymbol);
        ...
        // случайное число
        int randomNumber = 777;
        System.out.println("Случайное число = " + randomNumber);

        // математическое выражение
        int mathExpression = (5 + 3) * 2;
        ...
        // стоимость кофе
        int coffeeCost = 150;
        System.out.println("Стоимость кофе = " + coffeeCost + " руб.");

        // начальная дата
        int startDate = 1;
        System.out.println("Начальная дата = " + startDate + " января");
        ...
        String ramVendor = "Kingston";
        System.out.println("Производитель RAM = " + ramVendor);

        // емкость жесткого диска
        int hddCapacity = 1024; // ГБ
        System.out.println("Емкость HDD = " + hddCapacity + " ГБ");
